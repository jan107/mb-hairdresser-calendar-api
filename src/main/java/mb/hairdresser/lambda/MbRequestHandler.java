...
import mb.hairdresser.google.CalendarQuickstart;
	...
	public String handleRequest(InputLambdaRequest input, Context context) {
		...
		try {
			...
			if (items.isEmpty()) {
			    ...
			    jsonStr = "No upcoming events found.";
			} else {
			    ...
			    for (Event event : items) {
			        ...
			        calendarEvent.setDate(event.getStart().getDate());
			        
			        calendarEvents.add(calendarEvent);
			    }
			    
			    Gson gson = new Gson();    
			    jsonStr = gson.toJson(calendarEvents);
			}
